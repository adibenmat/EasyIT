...
namespace PowershellApiv2.Functions
{
    public class ReflectionHelper
    {
        ...
        public IEnumerable<string> GetObjectPropertiesNamesNotFromIPowershellItemInterface(object obj)
        {                    
                    foreach (var objProperty in obj.GetType().GetProperties())
                    {
                        if (!IsPropertyInInterface(objProperty, typeof(IPowershellItem)))
                            yield return objProperty.Name;
                    }
